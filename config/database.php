...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'FinanceAutomationSystem' => [
            'driver'                   => 'sqlsrv',
            'host'                     => env('SQLSRV_HOST', 'localhost'),
            'port'                     => env('SQLSRV_PORT', '1433'),
            'database'                 => 'FinanceAutomationSystem',
            'username'                 => env('FAS_SQLSRV_USERNAME', env('SQLSRV_USERNAME', '')),
            'password'                 => env('FAS_SQLSRV_PASSWORD', env('SQLSRV_PASSWORD', '')),
            'charset'                  => 'UTF-8',
            'prefix'                   => '',
            'encrypt'                  => env('SQLSRV_ENCRYPT', 'yes'),
            'trust_server_certificate' => env('SQLSRV_TRUST_SERVER_CERT', 'true'),
