...
<div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
    ...
    <div class="px-8 py-10 text-center">
        <div class="mb-4 leading-none">
            <span class="text-9xl font-extrabold tracking-tight text-red-100">500</span>
        </div>
        ...
        <h1 class="text-2xl font-bold text-gray-900 mb-3">Server Error</h1>
        <p class="text-gray-500 text-sm leading-relaxed mb-8 max-w-sm mx-auto">
            Something went wrong on our end. We've been notified and are working to resolve the issue.
        </p>
